...
** Last update Mon Jun 23 04:52:46 2008 florent hochwelker
*/
...
# define COEFFICIENT		3.0	/* en float */
...
*/
void		obs_add_client_in_char(char *buf, t_client *client, t_info *info, char is_a_bird);
